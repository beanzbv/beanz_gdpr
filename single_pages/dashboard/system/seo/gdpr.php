            ...
            <?php foreach ($locales as $locale) { ?>
                ...
                <div id="ccm-tab-content-<?php echo $code; ?>" class="<?php echo count($locales) > 1 ? 'ccm-tab-content' : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->text(
                            'title[' . $code . ']',
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.title'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.title')]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->textarea(
                            'message[' . $code . ']',
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.message'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.message'), 'rows' => 5]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->text(
                            'acceptButton[' . $code . ']',
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.accept_button'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.accept_button')]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->text(
                            'advancedButton[' . $code . ']',
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.advanced_button'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.advanced_button')]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->text(
                            'cookieTypes[' . $code . ']',
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.cookie_types'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.cookie_types')]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->text(
                            ...
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.fixed_cookie_label'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.fixed_cookie_label')]
                        ); ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo $form->textarea(
                            ...
                            Config::get('beanz.gdpr.disclosure.general.' . $code . '.fixed_cookie_description'),
                            ['placeholder' => Config::get('beanz.gdpr.disclosure.general.fallback.fixed_cookie_description'), 'rows' => 5]
                        ); ?>
                    </div>
                </div>
            <?php } ?>
...
<?php } else if ($controller->getAction() === 'type' || $controller->getAction() === 'saveType') { ?>
    ...
    <form method="post" action="<?php echo $this->action('saveType', $cookieType ? $cookieType->getHandle() : null); ?>">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <?php echo $form->label('scripts', t('Scripts')); ?>
                <?php echo $form->textarea('scripts', $cookieType ? $cookieType->getScripts() : '', ['rows' => 15]); ?>
            </div>
        </fieldset>
